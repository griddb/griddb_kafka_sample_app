...
// To decide which connector that Kafka should use as data-sink as well as what GridDB cluster the SimpleGridDBSinkConnector and
...
public class SimpleGridDBSinkConnector extends SinkConnector {
    ...
    public Class<? extends Task> taskClass() {
        return SimpleGridDBSinkTask.class;
    }
    ...
    @Override
    public void stop() {
        // Nothing to do since SimpleGridDBSinkConnector has no background monitoring.
    }
